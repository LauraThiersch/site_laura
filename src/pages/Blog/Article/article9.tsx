  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="https://www.laurathiersch.com.br/images/blog/escolher-neuropediatra-dicas.jpg" />
        ...
        <meta name="twitter:image" content="https://www.laurathiersch.com.br/images/blog/escolher-neuropediatra-dicas.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "image": "https://www.laurathiersch.com.br/images/blog/escolher-neuropediatra-dicas.jpg",
            "author": {
              "@type": "Person",
      ...
      <div className="article-content">
        ...
        <div className="indication-signs">
          ...
          <ul>
            <li><strong>Atraso no desenvolvimento:</strong> Marcos não alcançados na idade esperada</li>
            ...
            <li><strong>Suspeita de TEA:</strong> Sinais do transtorno do espectro autista</li>
            <li><strong>Crises convulsivas:</strong> Episódios suspeitos ou confirmados</li>
            <li><strong>Dores de cabeça frequentes:</strong> Cefaleia persistente em crianças</li>
            <li><strong>Alterações motoras:</strong> Fraqueza, tremores, coordenação</li>
          </ul>
        </div>
        ...
        <div className="qualifications">
          ...
          <ul>
            ...
            <li><strong>Residência em Pediatria:</strong> 2-3 anos de especialização</li>
            <li><strong>Residência em Neurologia Pediátrica:</strong> 2 anos adicionais</li>
            <li><strong>Registro no CRM:</strong> Conselho Regional de Medicina ativo</li>
            <li><strong>Título de Especialista:</strong> Reconhecido pela SBP/AMB</li>
          </ul>
        </div>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>SBP/AMB</td>
              <td>Reconhecimento oficial da especialização</td>
            </tr>
            <tr>
              <td>Membro da SBNP</td>
              <td>Sociedade Brasileira de Neurologia Pediátrica</td>
              <td>Atualização científica constante</td>
            </tr>
            <tr>
              <td>Certificações Internacionais</td>
              <td>Sociedades médicas internacionais</td>
              <td>Conhecimento global atualizado</td>
            </tr>
          </tbody>
        </table>
        ...
        <div className="selection-criteria">
          ...
          <ul>
            <li><strong>Tempo de atuação:</strong> Mínimo 5 anos de experiência</li>
            <li><strong>Área de especialização:</strong> TEA, TDAH, epilepsia, etc.</li>
        ...
        <div className="multidisciplinary-approach">
          ...
          <ul>
            ...
            <li><strong>Orientação terapêutica:</strong> Conhece profissionais qualificados</li>
        ...
        <div className="finding-sources">
          ...
          <ul>
            ...
            <li><strong>SBNP:</strong> Sociedade Brasileira de Neurologia Pediátrica</li>
            <li><strong>Hospitais renomados:</strong> Hospital das Clínicas, Santa Casa</li>
            <li><strong>Indicação médica:</strong> Pediatra de confiança</li>
            <li><strong>Planos de saúde:</strong> Rede credenciada</li>
            <li><strong>Universidades:</strong> UFMG, PUC-MG - corpo docente</li>
          </ul>
        </div>
        ...
        <div className="office-structure">
          ...
          <ul>
            <li><strong>Acessibilidade:</strong> Rampas, elevadores para cadeirantes</li>
            <li><strong>Sala de espera:</strong> Ambiente adequado e acolhedor para crianças</li>
            <li><strong>Consultório:</strong> Espaço amplo para avaliação neurológica</li>
            ...
            <li><strong>Higiene:</strong> Limpeza e organização evidentes</li>
          </ul>
        </div>
        ...
        <div className="first-consultation">
          ...
          <ul>
            <li><strong>Duração adequada:</strong> Mínimo 45-60 minutos</li>
        ...
        <h2>Questões Financeiras</h2>
        <h3>Estrutura de Custos em BH</h3>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td>R$ 350-600</td>
              <td>Mais longa e detalhada</td>
            </tr>
            <tr>
              <td>Consulta de retorno</td>
              <td>R$ 250-400</td>
              <td>Acompanhamento do tratamento</td>
            </tr>
            <tr>
              <td>Consulta de urgência</td>
              <td>R$ 400-700</td>
              <td>Fora do horário comercial</td>
            </tr>
          </tbody>
        </table>

        <h3>Modalidades de Pagamento</h3>
        <div className="payment-options">
          <h4>💳 Opções Disponíveis:</h4>
          <ul>
            <li><strong>Convênios médicos:</strong> Verificar cobertura para neuropediatria</li>
            <li><strong>Particular:</strong> Pagamento à vista ou parcelado</li>
            <li><strong>Planos de saúde:</strong> Reembolso conforme contrato</li>
            <li><strong>SUS:</strong> Disponível em alguns hospitais públicos</li>
            <li><strong>Parcelamento:</strong> Muitos consultórios oferecem facilidades</li>
          </ul>
        </div>
        ...
        <div className="warning-signs">
          ...
          <ul>
            ...
            <li><strong>Prometem cura milagrosa:</strong> Soluções não científicas</li>
            <li><strong>Não explicam procedimentos:</strong> Falta de transparência</li>
            <li><strong>Prescrevem medicação excessiva:</strong> Sem justificativa clara</li>
            <li><strong>Ignoram abordagem multidisciplinar:</strong> Visão muito limitada</li>
            <li><strong>Demonstram pressa excessiva:</strong> Consultas muito rápidas</li>
            <li><strong>Não respondem ligações:</strong> Inacessibilidade total</li>
            <li><strong>Desencorajam segunda opinião:</strong> Postura autoritária</li>
          </ul>
        </div>
        ...
        <div className="long-term-relationship">
          ...
          <ul>
            <li><strong>Confiança mútua:</strong> Base sólida do relacionamento</li>
            <li><strong>Comunicação aberta:</strong> Diálogo franco e honesto</li>
            <li><strong>Objetivos compartilhados:</strong> Bem-estar da criança</li>
            <li><strong>Flexibilidade:</strong> Adaptação às necessidades</li>
            <li><strong>Acompanhamento consistente:</strong> Monitoramento regular</li>
            <li><strong>Respeito mútuo:</strong> Valorização de ambas as partes</li>
          </ul>
        </div>
        ...
        <div className="evaluation-checklist">
          ...
          <ul>
            ...
            <li><strong>Experiência relevante:</strong> Casos similares ao seu filho</li>
            <li><strong>Avaliações positivas:</strong> Feedback de outros pais</li>
            <li><strong>Localização conveniente:</strong> Facilidade de acesso</li>
            <li><strong>Horários compatíveis:</strong> Disponibilidade que atende</li>
            <li><strong>Comunicação eficaz:</strong> Clareza nas explicações</li>
        ...
        <ul>
          ...
          <li><strong>Leve acompanhante:</strong> Suporte emocional</li>
          <li><strong>Reserve tempo:</strong> Não tenha pressa</li>
        </ul>

        <h2>Considerações Especiais</h2>
        <h3>Para Diferentes Condições</h3>
        <div className="special-considerations">
          <h4>🎯 Expertise Específica:</h4>
          <ul>
            <li><strong>TEA:</strong> Busque especialista em transtorno do espectro autista</li>
            <li><strong>TDAH:</strong> Experiência em déficit de atenção</li>
            <li><strong>Epilepsia:</strong> Conhecimento em eletroencefalografia</li>
            <li><strong>Atraso desenvolvimento:</strong> Avaliação neuropsicológica</li>
            <li><strong>Cefaleia:</strong> Experiência em dor de cabeça infantil</li>
          </ul>
        </div>
