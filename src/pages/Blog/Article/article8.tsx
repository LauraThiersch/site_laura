...
const Article8Page: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Dificuldades Escolares: Causas Neurológicas e Abordagem | Dra. Laura Thiersch</title>
        <meta name="description" content="Descubra como problemas neurológicos podem afetar o desempenho escolar. Dra. Laura Thiersch, neuropediatra em BH, explica TDAH, dislexia e outras causas." />
