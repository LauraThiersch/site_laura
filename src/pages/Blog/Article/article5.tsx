...
const Article5Page: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Tratamento do TDAH: Abordagens Eficazes e Individualizadas | Dra. Laura Thiersch</title>
        <meta name="description" content="Conheça as abordagens eficazes e individualizadas para tratamento do TDAH. Dra. Laura Thiersch, neuropediatra em BH, explica medicação, terapia e intervenções educacionais." />
        ...
        <meta property="article:tag" content="TDAH, Tratamento, Neuropediatria, Hiperatividade" />
      ...
      <article className="article-page">
        ...
        <div className="article-content">
          ...
          <ul>
            <li><strong>Medicação:</strong> Quando apropriada e indicada pelo médico</li>
            <li><strong>Terapia comportamental:</strong> Modificação de comportamentos, com auxílio da psicologia e terapia cognitivo-comportamental</li>
            <li><strong>Intervenções educacionais:</strong> Adaptações escolares de acordo com a necessidade de cada criança</li>
          ...
          <div className="medication-box">
            ...
            <p>A primeira linha de tratamento são os psicoestimulantes:</p>
            <ul>
              <li><strong>Metilfenidato</strong></li>
              <li><strong>Lisdexanfetamina</strong></li>
            </ul>
            <p>Ambos apresentam como benefício a melhora da atenção e concentração ao longo do dia. Como efeitos colaterais, podemos notar diminuição do apetite, insônia, perda de peso e irritabilidade.</p>
          </div>
          <h3>Medicamentos Não-Estimulantes</h3>
          <div className="medication-box">
            <h4>⚕️ Alternativas aos Estimulantes:</h4>
            <p>Em caso de contraindicação ou intolerância aos psicoestimulantes (primeira linha de tratamento), podemos considerar outras medicações, em especial:</p>
            <ul>
              <li><strong>Atomoxetina</strong></li>
              <li><strong>Clonidina</strong></li>
            </ul>
          </div>
          <h2>Terapia Comportamental</h2>
          <p>Dentre vários pontos possíveis de serem abordados na terapia comportamental, os seguintes podem ser trabalhados:</p>
          ...
          <p>No ambiente escolar, várias modificações podem ser feitas, a depender da necessidade de cada criança.</p>
          ...
          <div className="school-adaptations">
            ...
            <ul>
              ...
              <li><strong>Auxílio em organização:</strong> Calendários e lembretes</li>
            </ul>
          </div>
          <h2>Treinamento Parental</h2>
          <p>O treinamento parental é indispensável para o sucesso do tratamento! Podemos abordar técnicas relacionadas tanto ao comportamento quanto ao ambiente.</p>
          ...
          <div className="parenting-techniques">
            ...
            <ul>
              ...
              <li><strong>Sistema de pontos e recompensas</strong></li>
            </ul>
          </div>
          ...
          <p>Uma vez iniciado o tratamento, é indispensável a avaliação com regularidade pelo Neuropediatra!</p>
          <h3>Avaliação Regular</h3>
          <ul>
            <li><strong>Consultas regulares</strong></li>
          ...
          <ul>
            <li><strong>Dose da medicação:</strong> Otimização baseada em resposta e peso</li>
