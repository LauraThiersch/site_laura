...
const Article4Page: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Diagnóstico de TEA: Processo Completo e Abordagem Multidisciplinar | Dra. Laura Thiersch</title>
        <meta name="description" content="Conheça o processo completo de diagnóstico de TEA (Transtorno do Espectro Autista) com abordagem multidisciplinar. Dra. Laura Thiersch, neuropediatra em BH, explica cada etapa." />
        <meta name="keywords" content="diagnóstico TEA, processo diagnóstico autismo, avaliação multidisciplinar TEA, neuropediatra BH, Dra. Laura Thiersch, diagnóstico autismo infantil" />
        <meta name="author" content="Dra. Laura Thiersch" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://lauraneuroped.com.br/blog/diagnostico-tea-processo-completo" />
        ...
        <meta property="og:url" content="https://lauraneuroped.com.br/blog/diagnostico-tea-processo-completo" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "BlogPosting",
            "headline": "Diagnóstico de TEA: Processo Completo e Abordagem Multidisciplinar",
            "description": "Conheça o processo completo de diagnóstico de TEA (Transtorno do Espectro Autista) com abordagem multidisciplinar. Dra. Laura Thiersch, neuropediatra em BH, explica cada etapa.",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://lauraneuroped.com.br/blog/diagnostico-tea-processo-completo"
            },
            "articleSection": "TEA",
            "keywords": ["diagnóstico TEA", "processo diagnóstico autismo", "avaliação multidisciplinar", "neuropediatra BH", "diagnóstico autismo infantil"],
            "wordCount": "3500",
            "timeRequired": "PT12M",
            "inLanguage": "pt-BR",
            "about": [
        ...
        <div className="article-content">
          ...
          <div className="criteria-box">
            <ul>
              ...
              <li><strong>Rigidez e rotinas:</strong> Insistência em rotinas, rituais</li>
              <li><strong>Interesses fixos:</strong> Foco intenso em objetos e assuntos específicos</li>
              <li><strong>Sensorial:</strong> Hiper ou hipossensibilidade a estímulos sensoriais</li>
            </ul>
          </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Testes específicos quando aplicáveis</td>
              </tr>
              <tr>
                <td>Fonoaudiólogo</td>
          ...
          <ul>
            ...
            <li><strong>Histórico médico:</strong> Doenças, medicações, hospitalizações prévias</li>
            <li><strong>Histórico familiar:</strong> Casos de TEA ou outros transtornos na família</li>
          </ul>
          ...
          <h3>Etapa 3: Exames Complementares</h3>
          <p>Quando necessários:</p>
          <ul>
            <li><strong>Audiometria:</strong> Descartar problemas auditivos</li>
            <li><strong>EEG:</strong> Apenas se houver suspeita de epilepsia</li>
            <li><strong>Ressonância magnética:</strong> Casos específicos</li>
            <li><strong>Testes genéticos:</strong> A depender de cada caso</li>
          </ul>
          ...
          <div className="levels-box">
            ...
            <ul>
              ...
              <li>Comportamentos repetitivos interferem no funcionamento diário</li>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Habilidades sociais compatíveis com inteligência</td>
              </tr>
              <tr>
                <td>TDAH</td>
          ...
          <ul>
            <li><strong>Deficiência Intelectual</strong></li>
            <li><strong>Epilepsia</strong></li>
            <li><strong>TDAH</strong></li>
            <li><strong>Transtornos do Sono</strong></li>
            <li><strong>Problemas Gastrointestinais</strong></li>
          </ul>
          ...
          <div className="action-steps">
            ...
            <ol>
              <li><strong>Educação sobre TEA</strong></li>
              <li><strong>Estabelecer rede de apoio:</strong> Família, amigos, profissionais</li>
              <li><strong>Intervenções terapêuticas</strong></li>
              <li><strong>Adaptações escolares</strong></li>
              <li><strong>Garantir o cuidado parental:</strong> Não esquecer de cuidar de quem cuida!</li>
            </ol>
          </div>
          ...
          <div className="cta-article">
            ...
            <a href={`https://wa.me/${siteConfig.contact.whatsapp}`} className="btn-whatsapp">Agendar Avaliação</a>
          </div>
        </div>
      </article>
    </>
